...
const Hero = () => {
  ...
  <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
    ...
    <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
      Queremos estar em cada uma de suas jornadas em busca da satisfação de ver a beleza incorruptível da natureza. Podemos ajudá-lo em uma aventura ao redor do mundo com apenas um aplicativo.
    </p>
